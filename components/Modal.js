  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as='div' className='fixed z-10 inset-0 overflow-auto' onClose={setOpen}>
        ...
        {/*this element is to trick the browser into centering the model content */}
        ...
        enterTo="opacity-100 translate-y-o sm:scale-100"
        leave="ease-in duration-200"
        leaveFrom="opacity-100 translate-y-0 sm:scale-100"
        leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
        
        <div className='inline-block align-bottom bg-white rounded-lg px-4 pb-4 text-left
        overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6'>
          <div>
              ...
              <div className='mt-3 text-center sm:mt-5'>
                ...
                <div>
                  <input 
                    // ref={filePickerRef}
                    type="file"
                    hidden// onChange={addImageToPost}
                    />
                </div>
            ...
            <div className='mt-5 sm:mt-6'>
              <button type ="button" className='inline-flex justify-center w-full rounded-md border border-transparent
